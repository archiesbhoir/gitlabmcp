    ...
    const mockResponse: MRQueryResponse = {
      project: {
        ...
        mergeRequest: {
          ...
          targetBranch: 'main',
          webUrl: 'https://gitlab.example.com/group/project/-/merge_requests/123',
          ...
          author: {
            ...
            webUrl: 'https://gitlab.example.com/user',
          },
          assignees: {
            nodes: [],
          },
            ...
            nodes: [
              {
                ...
                webUrl: 'https://gitlab.example.com/group/project/-/commit/abc123',
              },
            ],
          },
          pipelines: {
